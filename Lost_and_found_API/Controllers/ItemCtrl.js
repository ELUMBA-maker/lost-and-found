...
export async function post_item(req,res) {
    try {
    const {
      title,
      description,
...
export async function my_items(req,res) {
    try {
    const result = await pool.query(
      `SELECT * FROM items
       WHERE user_id = $1
...
export async function get_item_by_id(req,res) {
     try {
    const result = await pool.query(
      `SELECT
         i.*,
...
export async function delete_items(req,res) {
    try {
    const result = await pool.query(
